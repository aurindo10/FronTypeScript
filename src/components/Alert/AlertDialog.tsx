  ...
  <AlertDialog>
    ...
    <AlertDialogContent >
      ...
      <AlertDialogDescription>
        Essa ação não poderá ser desfeita.Isso deletará permantemente o {props.typeOfContentToDelete} dos servidores.
      </AlertDialogDescription>
      <Flex css={{ justifyContent: 'flex-end' }}>
        ...
        <AlertDialogAction asChild>
          <Button onClick={()=>props.deleteFunction(props.id)} variant="red">{props.contentOnDialog}</Button>
        </AlertDialogAction>
      </Flex>
    </AlertDialogContent>
  </AlertDialog>
